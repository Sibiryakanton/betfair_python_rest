...
from .abstract_forms import LocaleField, StrategyRefs, MarketIdsField, PriceProjection
from dataclasses import dataclass
from datetime import datetime


@dataclass
class ListMarketBookForm(BaseForm, LocaleField, StrategyRefs, PriceProjection, MarketIdsField):
    '''
